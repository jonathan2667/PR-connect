...
AGENT_ADDRESS = os.environ.get('AGENT_ADRESS', "agent1qf376ss48kl8cpsc8pwtmtauscplngqrf0ku437ma5jwcvqw20r2jf38pzp")
...
# Simple CORS setup for development and production
CORS(app, origins=[
    "http://localhost:3000",
    "http://localhost:6969",
